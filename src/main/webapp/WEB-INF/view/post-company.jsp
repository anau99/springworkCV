  ...
  <div class="container">
    <div class="row no-gutters slider-text align-items-end justify-content-start">
      <div class="col-md-12 text-center mb-5">
        ...
        <h1 class="mb-3 bread">Danh sách công việc của công ty : <span >${companyName}</span></h1>
      </div>
    </div>
  </div>
</div>
                                  ...
                                  <form method="post" action="${pageContext.request.contextPath}/user/applyJob" enctype="multipart/form-data">
                                      <div class="modal-body">
                                          ...
                                          <div class="modal-footer">
                                              ...
                                              <input type="hidden" class="form-control"  name="posts-company" value="posts-company">
                                              <input type="hidden" class="form-control"  name="idCompany" value="${idCompany}">
